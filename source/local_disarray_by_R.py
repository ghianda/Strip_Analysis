...
def main(parser):
    ...
    R, matrix_of_disarray_perc, shape_G, isolated_value = estimate_local_disarray(R, parameters)
    ...
    disarray_fname = 'matrix_of_disarray_perc_g{}x{}x{}.npy'.format(shape_G[0], shape_G[1], shape_G[2])
